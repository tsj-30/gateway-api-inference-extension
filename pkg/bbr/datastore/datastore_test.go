...
func makeConfigMap(name, namespace, baseModel, adaptersYAML string) *corev1.ConfigMap {
...
func TestConfigMapUpdateOrAddIfNotExist_UpdateAdapters(t *testing.T) {
	...
	cmUpdated := makeConfigMap(cmName, cmNS, baseModel, "- a2\n- a3\n")
...
func TestConfigMapUpdateOrAddIfNotExist_InvalidConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			cm:   makeConfigMap(cmName, cmNS, baseModel, "["),
		},
	}
